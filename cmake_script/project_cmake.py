...
class cmake_tool(object):
    ...
    def get_link_libraries(self, item_group):
        ...
        self.link_libs += " mysqlclient boost_random boost_system boost_thread boost_filesystem " \
            "boost_date_time boost_locale boost_iostreams boost_random dl stdc++fs pthread event_pthreads"
